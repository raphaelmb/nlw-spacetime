...
export const metadata = {
  title: 'NLW Spacetime',
  description:
    'A time capsule created with React, Next.js, TailwindCSS and TypeScript',
}
    ...
    <html lang="en">
      ...
      >
        <main className="grid min-h-screen grid-cols-2">
          ...
          <div className="max-h-screen flex-col overflow-y-scroll bg-[url(../assets/bg-stars.svg)] bg-cover">
            {children}
          </div>
        </main>
      </body>
